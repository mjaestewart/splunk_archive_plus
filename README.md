...
- The  script is designed to copy originating db_ and rb_ Splunk Archive buckets to an Azure Blob Storage
...
## SET absolute path where Archive rb_ Removal log will reside
